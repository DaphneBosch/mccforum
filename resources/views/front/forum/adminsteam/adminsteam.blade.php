...
@section('title', 'MCC Forum | Admins Team')
            ...
            <div class="col-10">
                <div class="forumposts">
                    <div class="card bg-light mb-3 justify-content-center">
                        <div class="card-header"><h4>Admins Team</h4></div>

                        @foreach($poster as $posts)
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-4"><p class="card-text"><a class="nav-link" href="/adminsteam/{{$posts->id}}">{{ $posts->title }}</a></p></div>
