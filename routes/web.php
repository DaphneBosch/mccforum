...
Route::get('/events/{id}',['uses' => '\App\Http\Controllers\EventsController@getPost']);
Route::get('/server/{id}',['uses' => '\App\Http\Controllers\HomeController@getPost']);
Route::get('/adminsteam/{id}',['uses' => '\App\Http\Controllers\AdminsTeamController@getPost']);
Route::get('/news/{id}',['uses' => '\App\Http\Controllers\NewsController@getPost']);
